...
class ALNS ():
    def __init__(self, bestSolution, currentSolution ):
        ...
        # Customer removal operators // RANDOM HARİÇ DİĞERLERİ DENENECEK
        ...
        self.customerRemovalOps=[self.relatedCustomerRemovalOp,self.removeRandomCustomerRemovalOp,self.leastTimeWindowCustomerRemovalOp,self.worstDistanceCustomerRemovalOp]

        # Customer insertion operators // GREEDY INSERTION DENENECEK
        ...
        #CHARGE STATION REMOVAL OPERATORS // ALL WORKS
        ...
        #CHARGE STATION INSERTION OPERATORS //  COMPARE K DENENECEK
        ...
        # Route removal operators // GREEDY DENENECEK
